...
export default function TOC() {
    ...
    return (
        <ul className="nav nav-pills">
            ...
            <li className="nav-item">
                <a id="wd-k" href="https://github.com/KelsyF/kanbas-react-web-app.git" className="nav-link">
                    KelsyF GitHub Repo
                </a>
            </li>
            <li className="nav-item">
                <a id="wd-k" href="https://github.com/KelsyF/kanbas-node-server-app.git" className="nav-link">
                    KelsyF GitHub Server Repo
                </a>
            </li>
            <li className="nav-item">
                <a id="wd-k" href="https://kanbas-node-server-app-a6-x2ez.onrender.com" className="nav-link">
